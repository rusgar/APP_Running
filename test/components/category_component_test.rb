...
class CategoryComponentTest < ViewComponent::TestCase
  test "should render an empty category" do
    assert_equal(
      %(<a class=\"category text-gray-600 px-4 py-2 rounded-2xl  hover:bg-blue-200 bg-orange-200\" href=\"/\">Todas</a>),
  ...
  test "should render a category" do
    ...
    assert_equal(
      %(<a class=\"category text-gray-600 px-4 py-2 rounded-2xl  hover:bg-blue-200 bg-gray\" href=\"/?category_id=#{category.id}\">#{category.name}</a>),
